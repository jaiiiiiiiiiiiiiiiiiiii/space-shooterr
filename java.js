...
const basegamesound = new Audio("base gaem sound.wav")
const collisionsound = new Audio("base gaem sound.wav")
const shootingsound = new Audio("shoot.wav")
